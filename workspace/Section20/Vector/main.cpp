...
void test5() {
    ...
    stooges.pop_back();     //remove the back element of the vector
    display(stooges);
}
...
void test9() {
    ...
    //There ir also a front_inserter we ca use with deques and lists
    //Copy one list to another using an interator and back_inserter
