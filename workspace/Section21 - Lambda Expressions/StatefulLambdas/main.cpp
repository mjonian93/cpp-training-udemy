...
//from within the lambda using normal made lookup rules.
void test1() {
...
void test4() {
    ...
    int z {300};    //Note that z is not captured in the lambda since it is not used.
                    //This should produdce an 'unused variable' warning when compiling-
...
//the lambda body, all three of then will be captured by reference.
void test5() {
...
void test8() {
    ...
    //person.change_person1()("Moe", 30);     //This works also
