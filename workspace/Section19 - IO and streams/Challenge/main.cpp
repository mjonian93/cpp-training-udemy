...
void print_headers() {
    std::cout << std::setw(50) << "Tour Ticket prices from Miami" << std::endl << std::endl;
...
void print_country (Country country) {
    for (size_t i{0}; i < country.cities.size(); i++)  {
        std::cout << std::setw(20) << std::left << ((i==0) ? country.name : "")
                  << std::setw(25) << std::left << country.cities.at(i).name
                  << std::setw(10) << std::right << country.cities.at(i).population
